...
Use the defect classification in `references/defects.md` when reporting flaws.
...
3. **Cinematic craft**: framing, action, camera movement, pacing, and
   ...
   semantic form (see `references/cinematography.md` — Transition Semantics).

4. **Defects**: for each flaw, state the defect type from `references/defects.md`,
